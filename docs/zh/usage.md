...
付费计划支持在完成**前 N 分钟**收到通知。

在设置画面的「提前通知（分钟）」滑块中调整。设置为 0 则在完成时立即通知。

### 升级到付费套餐

免费套餐每月最多 30 条通知。超出需要付费套餐。

1. 在设置画面的「付款」部分选择套餐（1 / 6 / 12 个月）
2. 点击「购买」
3. 在 PAY.JP 付款页面输入银行卡信息
4. 付款完成后自动激活
